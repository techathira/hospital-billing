			...
			<div class="col-md-10 col-lg-10 col-sm-10 col-xs-12" style="margin-left:20px;margin-top:30px">
				<table style="border:1px solid black;width:100%;">
					...
					<tr style="height:10px;" ng-repeat="ip in display_ip">
						<td style="border-right:1px solid black;padding-left:5px;padding:4px;">{{$index+1}}</td>
						<td style="border-right:1px solid black;padding-left:5px;padding:4px;">IPBILLING-{{ip.bill_no}}</td>
					...
					<tr>
					   <td colspan="5" style="border-right:1px solid black;border-top:1px solid black;padding-left:5px;text-align:right;padding:2px;">Cash Total:{{cashamt}}</td>
