...
<html lang="en">
  ...
  <body class="nav-md" ng-app="view_histroy" ng-controller="histroyCtrl" ng-cloak >
      ...
      <div class="main_container">
		...
		<div class="col-md-12 col-sm-12 col-lg-12 col-xs-12 padding-none margin-bottom">
			...
			<div class="col-md-3 col-sm-3 col-lg-3 col-xs-4 font-18">
				<div class="group col-md-12 col-sm-12 col-lg-12"> 
				<div class="col-md-12 col-sm-12 col-lg-12 padding-none">	
					  <input type="text"  class="module-input" required="" datepicker="" ng-model="to_date" ng-change="filter_history()" />
				  <span class="bar"></span>
		...
		<div class="col-md-12 col-sm-12 col-lg-12 col-xs-12 margin-bottom" ng-repeat="display in patient_info" ng-show="show_data_div">
