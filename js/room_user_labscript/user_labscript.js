var app = angular.module('room_user_lab', []);

app.controller('room_user_lab_controller', ['$scope', '$http', function ($scope, $http) {
        // scope variables
		$scope.tests = {};
		$scope.test_name = {};
		$scope.addtional=[];
...
// display package
		...
		$scope.print_op_lab=function(packade_id){
		         ...
		         $http({     
										...
										data:{ package_id:$scope.edit_package.package_id, patient_id:$scope.patient_id, paymentmode: $scope.paymentmode, flag:$scope.flag,amount:$scope.total,paymode:$scope.display_pay_details1}
        ...
        $scope.print_screen = function(patient_id) {
		               ...
		               angular.forEach($scope.test_name, function(value, key) {
						...
						$http({     
										...
										data:{testnames:$scope.test_name, patient_id:patient_id, paymentmode: $scope.paymentmode, flag:$scope.flag,amount:$scope.total2,paymode:$scope.display_pay_details,add_charge:$scope.charges,addsum:$scope.addsum}
